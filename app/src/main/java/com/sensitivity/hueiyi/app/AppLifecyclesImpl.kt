...
import com.sensitivity.hueiyi.BuildConfig
...
class AppLifecyclesImpl : AppLifecycles {
    ...
    override fun onCreate(application: Application) {
        ...
        ArmsUtils.obtainAppComponentFromContext(application).extras().put(IntelligentCache.KEY_KEEP + RefWatcher::class.java.name, if (BuildConfig.USE_CANARY) LeakCanary.install(application) else RefWatcher.DISABLED)
